...
from qiskit_nature.second_q.operators.polynomial_tensor import PolynomialTensor
from qiskit_nature.second_q.operators.sparse_label_op import _TCoeff, SparseLabelOp, _to_number
        ...
        for label, coeff in op._data.items():
            ...
            for i in range(2 ** len(terms)):
                ...
                if simplify:
                    ...
                    majorana_label, new_coeff = FermionicOp._index_order(self='', terms=trms, coeff=new_coeff)
