import numpy as np
from src.nuqulib import get_Hamiltonian
from commutation_utils import commuting_groups_chunked, noncomm_cross_group_count_and_coeff_product_sum
import argparse
...
which_one_to_use = {
    ...
    "NN-only_1": ["TwBME-HO_NN-only_N3LO_EM500_srg1.8_hw20_emax1_e2max2.kshell.snt", None, "He4", 2, 2, 0, 0, 1, None],
    "NN-only_2": ["TwBME-HO_NN-only_N3LO_EM500_srg1.8_hw20_emax2_e2max4.kshell.snt", None, "He4", 2, 2, 0, 0, 2, None],
...
def main():
    ...
    keys = ["p_shell","sd_shell","pf_shell","psd_shell","NN-only_1","NN-only_2","NN+3NF_1_2_3","NN+3NF_2_4_6"]
